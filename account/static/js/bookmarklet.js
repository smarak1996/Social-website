...
(function(){
    ...
    function bookmarklet(msg) {
        ...
        // load HTML
        box_html = '<div id="bookmarklet"><a href="#" id="close">&link</a><h1>Select an image to bookmark:</h1><div class="images"></div></div>';
    ...
    jQuery.each(jQuery('img[src$="jpg"]'), function(index, image) {
        console.log(jQuery(image).width());
